...
export function AuthStack({ stack }: StackContext) {
    ...
    const auth: Auth = new Auth(stack, "Auth", {
        authenticator:{
            ...
            bind: ([
                // site,
                // pnpx sst secrets set GOOGLE_CLIENT_ID <YOUR GOOGLE_CLIENT_ID>
                // pnpx sst secrets set --stage dev GOOGLE_CLIENT_ID <YOUR GOOGLE_CLIENT_ID>
                // pnpx sst secrets set --stage prod GOOGLE_CLIENT_ID <YOUR GOOGLE_CLIENT_ID>
